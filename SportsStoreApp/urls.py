...
urlpatterns = [
    ...
    path('order_details/<int:order_id>/<int:total_price>/', views.order_details, name='order_details'),
    path('cancel_orders/<int:order_id>/', views.cancel_order, name='cancel_orders'),
